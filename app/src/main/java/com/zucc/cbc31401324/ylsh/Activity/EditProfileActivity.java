...
public class EditProfileActivity extends Activity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        profile = (EditText)findViewById(R.id.editsex);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.save:
                //TODO 保存简介
                final String userDetail = profile.getText().toString();
                Thread t = new Thread(){
                    @Override
                    public void run() {
                        ...
                        BasicNameValuePair bnvp7 = new BasicNameValuePair("userDetail", userDetail);
