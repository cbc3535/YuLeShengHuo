...
import com.zucc.cbc31401324.ylsh.MyListView;
import com.zucc.cbc31401324.ylsh.R;
import com.zucc.cbc31401324.ylsh.RecordSQLiteOpenHelper;
...
public class SearchActivity extends Activity implements android.view.View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                // TODO 获取到item上面的文字，根据该关键字跳转到钓点详情页面
            }
        });
    ...
    private void initView() {
        ...
        listView = (com.zucc.cbc31401324.ylsh.MyListView) findViewById(R.id.listView);
